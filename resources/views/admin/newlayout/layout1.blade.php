...
<head>
    ...
    <title>PM ShuHaRi-Admin Panel - @yield('title', '')</title>
    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <img alt="" src="{{asset('assets/admin/img/LATEST-55X55(1).png')}}"/>
...
{{--                    mainul--}}
                    <li>
                        <a href="/admin/user/role/list" class="nav-link"><i class="fas fa-user-alt-slash"></i> <span>Student Role</span></a>
                    </li>
                    ...
                    @if(checkAccess('email'))
                        <li class="dropdown" id="email">
                            ...
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-envelope"></i> <span>Email Settings</span></a>
                            <ul class="dropdown-menu">
