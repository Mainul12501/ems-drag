    ...
    <div class="row ucp-menu-item">
        <div class="container">
            ...
            <div class="seven-cols">
                ...
                @if($user['vendor'] != 1)
                <div class="col-md-1 col-sm-6 col-xs-6 tab-con">
                    <a href="/user/simulator" class="item-box sbox3" id="request-hover">
                ...
                @if($user['vendor'] != 1)
                <div class="col-md-1 col-sm-6 col-xs-6 tab-con">
                    <a href="/profile/{{ $user['id'] }}" class="item-box sbox3" id="ticket-hover">
                        <span class="micon mdi mdi-finance"></span>
                        <span>My DeepDive</span>
                    </a>
                </div>
                @endif
                @if($user['vendor'] == 1)
                <div class="col-md-1 col-sm-6 col-xs-6 tab-con">
                    <a href="/user/quizzes" class="item-box sbox3" id="buy-hover">
                        <span class="micon mdi mdi-library-video"></span>
                        <span>Quiz</span>
                    </a>
                </div>
                ...
                <!-- <div class="col-md-1 col-sm-6 col-xs-6 tab-con">
                    <a href="/user/simulator/category" class="item-box sbox3" id="article-hover">
                        <span class="micon mdi mdi-notebook"></span>
