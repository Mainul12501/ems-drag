                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-1 tab-con">Address</Address></label>
                                    <div class="col-md-5 tab-con">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5 tab-con">
                                        <input type="date" name="birthday" value="{{ !empty($meta['birthday']) ? $meta['birthday'] : '' }}" class="form-control">
                                    </div>
