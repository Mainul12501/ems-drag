...
@section('title')
    ...
    - Simulated Exam - {{ $localData['sim_qty'] }} questions
@endsection
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2 quiz-wizard">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <div>
                            <div>
                                <h2 class="quiz-name">Simulated Exam</h2>
                                <span class="course-name d-block">{{ $localData['sim_qty'] }} Questions</span>
                            </div>
                        </div>
                        <div class="quiz-time">
                    ...
                    <div class="row">
                        <div class="col-md-12" id="dtBasicExample">
                            <form id="quizForm" action="/user/quizzes/{{ $quiz->id }}/store_results-mega" method="post" class="quiz-form">
                                ...
                                <input type="hidden" name="sim_pass_mark" value="{{ $localData['sim_pass_mark'] }}">
                                <input type="hidden" name="sim_qty" value="{{ $localData['sim_qty'] }}">
...
{{--                                        <input type="hidden" name="question[{{ $question->id }}]" value="{{ $question->id }}">--}}
                                        ...
                                        <div class="form-card" id="fildset{{ $question->id }}">
                                            ...
                                            <h3 class="question-title" style="margin-top: 55px">{{ $loop->iteration }} - {{ $question->title }}</h3>
...
{{--                                                                <input id="asw{{ $answer->id }}" type="checkbox" name="question[{{ $question->id }}][answer]" value="{{ $answer->id }}">--}}
                                                                <input id="asw{{ $answer->id }}" type="checkbox" name="question[{{ $question->question_id }}][answer]" value="{{ $answer->id }}">
...
{{--                                                                <input id="asw{{ $answer->id }}" type="radio" name="question[{{ $question->id }}][answer]" value="{{ $answer->id }}">--}}
                                                                <input id="asw{{ $answer->id }}" type="radio" name="question[{{ $question->question_id }}][answer]" value="{{ $answer->id }}">
