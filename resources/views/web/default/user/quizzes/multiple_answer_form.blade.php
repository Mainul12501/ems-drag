        ...
        <div class="row">
            ...
            <div class="col-md-4 pull-left">
                <div class="form-group">
                    ...
                    <div class="">
                        <input type="radio" class="" name="answers[{{ (empty($answer) or (!empty($loop) and $loop->iteration == 1)) ? 'record' : $answer->id }}][correct]" value="1" @if(!empty($answer) and $answer->correct) checked @endif> <span class="" style="font-size: 16px">YES</span>
                        <input type="radio" class="" name="answers[{{ (empty($answer) or (!empty($loop) and $loop->iteration == 1)) ? 'record' : $answer->id }}][correct]" value="0" {{ !empty($answer) ? '' : 'checked' }} @if(!empty($answer) and !$answer->correct) checked @endif> <span class="" style="font-size: 16px">NO</span>
                    </div>
                </div>
            </div>
        </div>
