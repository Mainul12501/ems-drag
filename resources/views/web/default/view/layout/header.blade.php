    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="row middle-header">
            {{-- <div class="col-md-3 col-xs-12 tab-con"> --}}
             <div class="col-md-3 col-xs-12 tab-con test">
                    <div class="row">
                        ...
                        <a href="{{URL::to('https://pmshuhari.com/')}}"><img src={{asset('/bin/admin/pmwebclass/200X55.png')}} alt="Logo"></a>
                    </div>
              </div>
            {{-- </div> --}}
            ...
            <div class="col-md-4 col-xs-12 text-center tab-con">
                <div class="row">
                <a href="/" class="header-upload-button pulse"><span class="headericon mdi mdi-arrow-up-bold"></span>Home Page</a>
