<div class="container-fluid" id="footer">
    <div class="container">
        <div class="col-md-6 col-xs-12 tab-con login-container">
...
<div class="container-fluid footer-blow">
    ...
    <div class="col-md-9 col-xs-12">
        <span class="copyright">
           ...
           <img alt="" src="{{asset('assets/admin/img/48X48 (1).png')}}"/>&nbsp&nbsp © PM ShuHaRi 2021, All Rights Reserved.  Developed by <a href="https://trendsbird.com">Trends Bird Limited</a>
        </span>
         <!-- <span class="copyright">
             {{ trans('main.copyright2') }}
             Developed by <a href="https://trendsbird.com">Trends Bird Limited</a>
        </span>  -->
    </div>
</div>
