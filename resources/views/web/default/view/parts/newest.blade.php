        ...
        <div class="row">
            ...
            <div class="body body-s-r" dir="ltr">
              ...
              {{-- <div class="col-md-3 plan-box tab-con">
                                    ...
                                    <div class="plan-box-section plan-box-section-s">Free 100 Questions</div>
                                    <div class="plan-box-section plan-box-section-r">Price $100</div>
                ...
                <div class="col-md-4 plan-box tab-con">
                                    <div class="price-section">Simulator</div>
                                    <div class="plan-box-section plan-box-section-s">Free 50 Questions</div>
                                    ...
                                    <div class="plan-box-section"><a href="/product/12" class="btn btn-custom"><b>{{ trans('main.purchase_plan') }}<b></a></div>
