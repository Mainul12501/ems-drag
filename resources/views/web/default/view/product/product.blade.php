            ...
            <div class="container">
                <div class="col-md-4 col-xs-12 course_details">
                    <div class="product-details-box">
                        ...
                        <span class="pn-category">Simulator</span>
                    </div>
                    ...
                    <div class="product-details-box">
                        ...
                        <span class="proicon mdi mdi-calendar-month"></span><span>3000 Questions</span>
                    </div>
                    <div class="product-details-box">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="radio">
                                    ...
                                    &nbsp;
                                    <label class="radio-label" for="mode-1">SSL Ecommerce &nbsp;<b id="credit-remain-modal">({{ currencySign() }}{{ $user['credit'] }})</b></label>
                                </div>
...
{{--                                <a href="javascript:void(0);" class="btn btn-custom pull-left" id="buyBtn">{{ trans('main.purchase') }}</a>--}}
                                <a href="#" class="btn btn-custom pull-left" onclick="event.preventDefault(); document.getElementById('payForm').submit();" id="buyBtn">{{ trans('main.purchase') }}</a>
                                <form action="{{ url('/pay') }}" method="post" id="payForm">
                                    @csrf
                                    <input type="hidden" name="total_amount" value="{{ price($product->id,$product->category->id,$meta['price'])['price'] }}">
...
{{--                var buyLink = '/bank/' + $(this).val() + '/pay/{{ $product->id }}/' + $('#buy_method').val();--}}
                var buyLink = 'https://sandbox.sslcommerz.com/EasyCheckOut/testcde5f4efbcd6f63f43d93879e4cbf4946ec';
