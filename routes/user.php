...
Route::group(['prefix' => 'user'], function () {
    Route::group(['middleware' => ['user', 'notification']], function () {
        ...
        //     Route::get('', 'UserController@simulators');
        //     Route::get('list', 'UserController@simulators');
        //     // Route::get('new', 'UserController@articleNew');
        //     // Route::post('store', 'UserController@articleStore');
        //     // Route::get('edit/{id}', 'UserController@articleEdit');
        //     // Route::post('edit/store/{id}', 'UserController@articleUpdate');
        ...
        // });
 // new code start
        Route::get('/simulated-questions','UserController@simForm')->name('sim-que');
        Route::get('/get-ans/{id}','UserController@getAns')->name('get-ans');
// new code end

        Route::get('/simulator', 'UserController@SimulatorList');
        Route::get('/simulator/new', 'UserController@SimulatorNew');
        // Route::get('/dragdrop', 'UserController@SimulatorList');

        Route::get('/simulator/answer', 'UserController@SimulatorAnswer');

        // Route::get('/simulator/category', 'UserController@CategoryList');
        // Route::get('/simulator/category', 'UserController@manageCategory');

        // Route::get('/simulator', 'UserController@SimulatorList');
        Route::get('/simulator/category', 'UserController@CategoryList');
        Route::post('/subcat', 'UserController@subCat');
        ...
        ############drag-drop###########
        ###############################
        Route::get('/simulator/dragdrop', 'UserController@DragDrop');
        ...
        Route::group(['prefix' => 'quizzes'], function () {
            ...
            // Route::post('/update','UserController@QuizzesUpdate');
            // Route::get('/') quizzes
            ...
            Route::post('/{quiz_id}/store_results-mega', 'UserController@megaQuizzesStoreResult');
            ...
            Route::get('/results/{result_id}/final', 'UserController@megaStudentQuizzesResults');
...
//            Route::get('/set-ans/{question_id}/{answer_id}', 'UserController@QuizzesResultsReviewed');

            Route::get('/', 'UserController@QuizzesList');
        });
## pm webclass questions
...
//        if ($user->vendor == 1)
//        {
//            $user->student_role_id  = 4;
//            $user->save();
//        } else
//        {
//            $user->student_role_id  = 1;
//            $user->save();
//        }
//
//    }
...
//    $currentDate    = \Carbon\Carbon::now()->toDateTimeString();
    $expireDate = $currentDate->addDays(180)->toDateTimeString();
    return $expireDate;
});
